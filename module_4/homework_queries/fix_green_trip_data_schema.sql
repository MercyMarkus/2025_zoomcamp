create table `weighty-pixel-448710-u7.module_4_homework.green_trips` (
VendorID INT64,
...
insert into `weighty-pixel-448710-u7.module_4_homework.green_trips`
select 
...
CAST(trip_type AS INT64),
CAST(congestion_surcharge AS NUMERIC)
from `weighty-pixel-448710-u7.module_4_homework.green`;